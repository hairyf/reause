 ...
 * the Network Information API (`navigator.connection`) combined with the window `online`/`offline`
 * events.
 *
 * React divergences:
 ...
 *   (SSR-safe);
 * - the window `online`/`offline` and `connection` `change` listeners (upstream `useEventListener`,
 * passive) live in one self-contained `useEffect`;
