...
| mantine     | `getElementHeight`                | —                                             | `packages/core/useCollapse/index.tsx`                     | ✅ ported (not in pinned submodule) |
| mantine     | `getHotkeyHandler`                | —                                             | `packages/core/useHotkeys/index.tsx`                      | ✅ ported (not in pinned submodule) |
| mantine     | `getHotkeyMatcher`                | —                                             | `packages/core/useHotkeys/index.tsx`                      | ✅ ported (not in pinned submodule) |
...
| mantine     | `isMeasured`                      | —                                             | `packages/core/useCollapse/index.tsx`                     | ✅ ported (not in pinned submodule) |
...
| mantine     | `parseHotkey`                     | —                                             | `packages/core/useHotkeys/index.tsx`                      | ✅ ported (not in pinned submodule) |
...
| mantine     | `useCollapse`                     | —                                             | `packages/core/useCollapse/index.tsx`                     | ✅ ported (not in pinned submodule) |
...
| mantine     | `useFocusReturn`                  | —                                             | `packages/core/useFocusReturn/index.tsx`                  | ✅ ported (not in pinned submodule) |
...
| mantine     | `useHotkeys`                      | —                                             | `packages/core/useHotkeys/index.tsx`                      | ✅ ported (not in pinned submodule) |
| mantine     | `useId`                           | —                                             | `packages/core/useId/index.tsx`                           | ✅ ported (not in pinned submodule) |
...
| mantine     | `useIsFirstRender`                | —                                             | `packages/shared/useIsFirstRender/index.tsx`              | ✅ ported (not in pinned submodule) |
...
| ahooks      | `useLockFn`                       | packages/hooks/src/useLockFn                  | `packages/shared/useLockFn/index.tsx`                     | ✅ ported                           |
...
| react-hookz | `useMap`                          | —                                             | `packages/shared/useMap/index.tsx`                        | ✅ ported (not in pinned submodule) |
| mantine     | `useMask`                         | —                                             | `packages/core/useMask/index.tsx`                         | ✅ ported (not in pinned submodule) |
...
| react-use   | `usePreviousDistinct`             | src/usePreviousDistinct.ts                    | `packages/shared/usePreviousDistinct/index.tsx`           | ✅ ported                           |
...
| react-hookz | `useSet`                          | —                                             | `packages/shared/useSet/index.tsx`                        | ✅ ported (not in pinned submodule) |
...
| mantine     | `useSplitter`                     | —                                             | `packages/core/useSplitter/index.tsx`                     | ✅ ported (not in pinned submodule) |
